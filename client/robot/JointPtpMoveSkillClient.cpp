...
JointPtpMoveSkillClient::JointPtpMoveSkillClient(const std::shared_ptr<spdlog::logger> &loggerParam,
...
std::future<void> JointPtpMoveSkillClient::move(const double targetJointPosition[],
