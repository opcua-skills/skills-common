...
JointPtpMoveSkillClient::JointPtpMoveSkillClient(
        ...
        PtpMoveSkillClient(loggerApp, loggerOpcua, serverURL, nsIdxDi, nsIdxRobFor, skillNodeId, axisCount, username, password, clientCertPath, clientKeyPath,
                           clientAppUri, clientAppName) {

}

std::future<void> JointPtpMoveSkillClient::move(
    ...
    for (int i = 0; i < JointMoveSkillClient::axisCount; i++)
