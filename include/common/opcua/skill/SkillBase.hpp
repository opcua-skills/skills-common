...
namespace fortiss {
    ...
    namespace opcua {
        namespace skill {
            ...
            public:
                explicit SkillBase(UA_Server *server,
                                        const std::shared_ptr<spdlog::logger> &logger, const UA_NodeId &skillNodeId,
            ...
            protected:
                ...
                void setImpl(SkillImpl *i, std::function<void()> deleter) {
                    this->impl = i;
                    this->implDeleter = deleter;
                }
                ...
                UA_StatusCode readParameter(
                    ...
                    return readParameter<T, T, 1>(parameter, [set](const T &x, size_t index) {
                        set(x);
                    });
                }
                ...
                UA_StatusCode readParameter(
                    ...
                    return readParameter<T, U, 1>(parameter, [set](const U &x, size_t index) {
                        set(x);
                    });
                }
                ...
                UA_StatusCode readParameter(
                        const SkillParameter<T> &parameter,
                        const std::function< void(const U&, size_t index) >& set) {
                    UA_Variant var;
                    UA_StatusCode retval = UA_Server_readValue(server, *parameter.nodeId,
                                                               &var);
                ...
                UA_StatusCode startMethod(const UA_NodeId *sessionId, void *sessionHandle,
                                          const UA_NodeId *methodId, void *methodContext,
                                          const UA_NodeId *objectId, void *objectContext,
                                          size_t inputSize, const UA_Variant *input,
                                          size_t outputSize, UA_Variant *output) override {
                    this->readParameters();
                ...
                UA_StatusCode resumeMethod(const UA_NodeId *sessionId, void *sessionHandle,
                                           const UA_NodeId *methodId, void *methodContext,
                                           const UA_NodeId *objectId, void *objectContext,
                                           size_t inputSize, const UA_Variant *input,
                                           size_t outputSize, UA_Variant *output) override {
                ...
                UA_StatusCode resetMethod(const UA_NodeId *sessionId, void *sessionHandle,
                                          const UA_NodeId *methodId, void *methodContext,
                                          const UA_NodeId *objectId, void *objectContext,
                                          size_t inputSize, const UA_Variant *input,
                                          size_t outputSize, UA_Variant *output) override {
                ...
                UA_StatusCode haltMethod(const UA_NodeId *sessionId, void *sessionHandle,
                                         const UA_NodeId *methodId, void *methodContext,
                                         const UA_NodeId *objectId, void *objectContext,
                                         size_t inputSize, const UA_Variant *input,
                                         size_t outputSize, UA_Variant *output) override {
                ...
                UA_StatusCode suspendMethod(const UA_NodeId *sessionId, void *sessionHandle,
                                            const UA_NodeId *methodId, void *methodContext,
                                            const UA_NodeId *objectId, void *objectContext,
                                            size_t inputSize, const UA_Variant *input,
                                            size_t outputSize, UA_Variant *output) override {
            ...
            private:
                static const std::vector<ProgramState> generateStates(UA_Server *server) {
                    ...
                    return {ProgramState(ProgramStateNumber::HALTED,
                                         UA_Server_getObjectComponentId(server, UA_NODEID_NUMERIC(0, UA_NS0ID_PROGRAMSTATEMACHINETYPE),
